    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link text-light text-decoration-none" href="/Templates/Console/Calendar/_fetch.php"><i class="bi bi-table"></i> Planning</a>
                </li>
            ...
            <form class="d-flex gap-2">
                ...
                if (is_cmd($_SESSION['uid'])) {
                    ...
                    echo '<a href="/services/_signout.php" class="btn bg-danger text-light shadow-none rounded-0 w-100"><i class="bi bi-box-arrow-right"></i></a>';
